...
struct _environmentNode {
	...
	union {
		syntaxnode* ast;
		syntaxnode* (*primitive)(struct _environmentNode*, syntaxnode*); 	//a primitive is a C function that takes in an enironment and an AST and gives back an AST
	};
...
typedef syntaxnode* (*primitiveFunction)(environmentNode*, syntaxnode*);
